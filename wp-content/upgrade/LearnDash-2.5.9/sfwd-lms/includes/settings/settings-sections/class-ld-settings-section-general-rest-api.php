		...
		function load_settings_fields() {
			...
			$this->setting_option_fields = array(
				...
				'sfwd-courses' => array(
					'name'  		=> 'sfwd-courses',
					'type'  		=> 'text',
					'label' 		=> sprintf( _x( '%s Endpoint Slug', 'placeholder: Course', 'learndash' ), LearnDash_Custom_Label::get_label( 'course' ) ),
				...
				'sfwd-lessons' => array(
					'name'  		=> 	'sfwd-lessons',
					'type'  		=> 	'text',
					'label' 		=> 	sprintf( _x( '%s Endpoint Slug', 'placeholder: Lesson', 'learndash' ), LearnDash_Custom_Label::get_label( 'lesson' ) ),
				...
				'sfwd-topic' => array(
					'name'  		=> 	'sfwd-topic',
					'type'  		=> 	'text',
					'label' 		=> 	sprintf( _x( '%s Endpoint Slug', 'placeholder: Topic', 'learndash' ), LearnDash_Custom_Label::get_label( 'topic' ) ),
				...
				'sfwd-quiz' => array(
					'name'  		=> 	'sfwd-quiz',
					'type'  		=> 	'text',
					'label' 		=> 	sprintf( _x( '%s Endpoint Slug', 'placeholder: Quiz', 'learndash' ), LearnDash_Custom_Label::get_label( 'quiz' ) ),
