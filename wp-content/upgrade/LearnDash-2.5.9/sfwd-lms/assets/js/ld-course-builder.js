jQuery(document).ready(function($) {
	...
	//console.log('learndash_course_builder_assets[%o]', learndash_course_builder_assets);

	var touch = ('ontouchstart' in window) || window.DocumentTouch && document instanceof DocumentTouch;
	var touchEvent = touch ? 'touchstart' : 'hover';
	
	if ( jQuery( '#learndash_course_builder_box_wrap' ).length ) {
		course_id = jQuery( '#learndash_course_builder_box_wrap' ).data('ld-course-id');
	}

	if ( jQuery( '#learndash_course_builder_box_wrap .learndash_selectors' ).length ) {

		// set the first selector set to open by default. 
		jQuery( '#learndash_course_builder_box_wrap .learndash_selectors .learndash-selector-container' ).each(function (index, item) {
			if ( index == 0 ) {
		...
		function course_builder_box_wrap_resize( e ) {
			jQuery( window ).resize(function() {
				...
				//var ld_course_builder_box_wrap_width = jQuery( '#learndash_course_builder_box_wrap' ).width();
				//console.log('ld_course_builder_box_wrap_width[%o]', ld_course_builder_box_wrap_width);
				//if ( ld_course_builder_box_wrap_width < 500 ) {
				//	jQuery( '#learndash_course_builder_box_wrap .learndash_selectors' ).css( 'width', '40%' );
				//	jQuery( '#learndash_course_builder_box_wrap .learndash_builder_items' ).css( 'width', 'calc(60% - 5px)' );
				//} else {
				//	jQuery( '#learndash_course_builder_box_wrap .learndash_selectors' ).css( 'width', '30%' );
				//	jQuery( '#learndash_course_builder_box_wrap .learndash_builder_items' ).css( 'width', 'calc(70% - 5px)' );
				//}
				...
				//var ld_course_builder_selectors_width = jQuery( '#learndash_course_builder_box_wrap .learndash_selectors' ).outerWidth();
				...
				//jQuery( '#learndash_course_builder_box_wrap .learndash_builder_items' ).width(new_Width-25);
		...
		*/
		...
		jQuery( '#learndash_course_builder_box_wrap .learndash_selectors' ).on( 'click', '.ld-course-builder-action-show-hide', selector_show_hide );
		...
		jQuery( '#learndash_course_builder_box_wrap .learndash_selectors' ).on( 'click', 'li', selector_click_item );
		...
		jQuery( '#learndash_course_builder_box_wrap' ).on( 'click', '.learndash_selectors .pager-info button', selector_pager_click );
		...
		function selector_pager_process( selector_paged, selector_type, selector_container ) {
			var post_data = {
				'action': 'learndash_course_builder_selector_pager',
				'course_id': course_id,
				'query_args': {
	...
	function build_html_element_map( ) {
		...
		jQuery( '#learndash_course_builder_box_wrap .learndash_builder_items .ld-course-builder-lesson-items' ).children().each(function( lesson_item_idx, lesson_item) {
		...
		jQuery('#learndash_course_builder_box_wrap .learndash_builder_items .ld-course-builder-course-quiz-items' ).children().each(function( quiz_item_idx, quiz_item) {
	...
	draggable_objects['sfwd-lessons'] = {
		...
		connectToSortable: '#learndash_course_builder_box_wrap .ld-course-builder-lesson-items',
		helper: function() {
	...
	draggable_objects['sfwd-topic'] = {
        ...
        connectToSortable: '#learndash_course_builder_box_wrap .ld-course-builder-topic-items',
		//cursor: 'move',
		helper: function() {
	...
	draggable_objects['sfwd-quiz'] = {
        ...
        connectToSortable: '#learndash_course_builder_box_wrap .ld-course-builder-quiz-items',
		//cursor: 'move',
		helper: function() {
	...
	sortable_objects['sfwd-lessons'] = {
        //containment: "#learndash_course_builder_box_wrap",
		...
		stop: function(event, ui) {
			...
			if ( element_id == 'ld-selector-draggable-group' ) {
				...
				var ld_selected = jQuery('#learndash_course_builder_box_wrap .learndash_selectors .learndash-selector-container-sfwd-lessons').data('ld-selected');
				...
				ui.item.children('li').each( function( ) {
					...
					//var edit_href = jQuery( 'span.ld-course-builder-sub-actions a.ld-course-builder-action-edit', inner_el ).attr('href');
					//jQuery( 'span.ld-course-builder-sub-actions a.ld-course-builder-action-edit', inner_el ).attr('href', edit_href+'&course_id='+learndash_course_builder_assets['course_id'] );
				...
				jQuery("#learndash_course_builder_box_wrap .ld-course-builder-topic-items").sortable( sortable_objects['sfwd-topic'] );
				jQuery("#learndash_course_builder_box_wrap .ld-course-builder-quiz-items").sortable( sortable_objects['sfwd-quiz'] );

				ld_selected = jQuery.unique( ld_selected );	
				jQuery( '#learndash_course_builder_box_wrap .learndash_selectors .learndash-selector-container-sfwd-lessons' ).data( 'ld-selected', ld_selected );
								
				update_course_builder_steps_element();
	...
	sortable_objects['sfwd-topic'] = {
		...
		stop: function(event, ui) {
			...
			if ( element_id == 'ld-selector-draggable-group' ) {
				...
				var new_lessons = '';
				var ld_selected = jQuery('#learndash_course_builder_box_wrap .learndash_selectors .learndash-selector-container-sfwd-topic').data('ld-selected');
				if ( typeof ld_selected === 'undefined' ) {
					ld_selected = [];
				}
				...
				ui.item.children('li').each( function( ) {
					...
					if ( typeof element_ld_id !== 'undefined' ) {
						...
						jQuery('#learndash_course_builder_box_wrap .learndash_selectors .learndash-selector-container-sfwd-topic li#ld-post-'+element_ld_id).removeClass('ld-selected');
					}
				});
				jQuery( ui.item ).replaceWith( new_lessons );
				...
				ld_selected = jQuery.unique( ld_selected );
				jQuery( '#learndash_course_builder_box_wrap .learndash_selectors .learndash-selector-container-sfwd-topic' ).data( 'ld-selected', ld_selected );
	...
	sortable_objects['sfwd-quiz'] = {
		...
		stop: function(event, ui) {
			...
			if ( element_id == 'ld-selector-draggable-group' ) {
				...
				var new_lessons = '';
				var ld_selected = jQuery('#learndash_course_builder_box_wrap .learndash_selectors .learndash-selector-container-sfwd-quiz').data('ld-selected');
				if ( typeof ld_selected === 'undefined' ) {
					ld_selected = [];
				}
				...
				ui.item.children('li').each( function( ) {
					...
					if ( typeof element_ld_id !== 'undefined' ) {
						...
						jQuery('#learndash_course_builder_box_wrap .learndash_selectors .learndash-selector-container-sfwd-quiz li#ld-post-'+element_ld_id).removeClass('ld-selected');
					}
				});
				jQuery( ui.item ).replaceWith( new_lessons );

				ld_selected = jQuery.unique( ld_selected );
				jQuery( '#learndash_course_builder_box_wrap .learndash_selectors .learndash-selector-container-sfwd-quiz' ).data( 'ld-selected', ld_selected );
				update_course_builder_steps_element();
    ...
    jQuery('#learndash_course_builder_box_wrap .learndash_selectors ul#learndash-selector-post-listing-sfwd-lessons li').draggable( draggable_objects['sfwd-lessons'] );
    jQuery('#learndash_course_builder_box_wrap .learndash_builder_items .ld-course-builder-lesson-items').sortable( sortable_objects['sfwd-lessons'] );
	
	
    // Draggable / Sortable Topics
    jQuery( '#learndash_course_builder_box_wrap .learndash_selectors ul#learndash-selector-post-listing-sfwd-topic li' ).draggable( draggable_objects['sfwd-topic'] );
    jQuery( '#learndash_course_builder_box_wrap .ld-course-builder-topic-items' ).sortable( sortable_objects['sfwd-topic'] );

    // Draggable / Sortable Quizzes
    jQuery( '#learndash_course_builder_box_wrap .learndash_selectors ul#learndash-selector-post-listing-sfwd-quiz li' ).draggable( draggable_objects['sfwd-quiz'] );
    jQuery( '#learndash_course_builder_box_wrap .ld-course-builder-quiz-items' ).sortable( sortable_objects['sfwd-quiz'] );


	function update_course_builder_steps_element() {
		cb_form_unsaved = true;
		
		builder_items_count = 0;
		
		var builder_elements = build_html_element_map();
		jQuery( '#learndash_course_builder_box_wrap .learndash_builder_items .ld-course-steps-total .ld-course-steps-value').html( builder_items_count );		
		
		var builder_elements_str = JSON.stringify( builder_elements );
		jQuery( '#learndash_course_builder_box_wrap input#learndash_course_builder_data' ).val(builder_elements_str);
	}
	
	jQuery( '#learndash_course_builder_box_wrap .learndash_builder_items').on('click', '.ld-course-builder-action-show-hide', show_hide_sub_elements );	
	...
	jQuery( '#learndash_course_builder_box_wrap .learndash_builder_items' ).on( 'click', '.ld-course-builder-action-remove', builder_remove_element );
	...
	function builder_remove_element( event ) {
		...
		var confirm_title = learndash_course_builder_assets['confirm_remove_'+remove_item_type];
		if ( confirm_title === '' ) {
	...
	jQuery( '#learndash_course_builder_box_wrap .learndash_selectors' ).on( 'click', '.ld-course-builder-action-trash', builder_trash_element );
	function builder_trash_element( event ) {
		...
		var confirm_title = learndash_course_builder_assets['confirm_trash_'+trash_item_type];
		if ( confirm_title === '' ) {
			confirm_title = 'Confirm delete';
		}
		...
		if ( confirm( confirm_title ) ) {
			...
			var post_data = {
				'action': 'learndash_course_builder_selector_trash_step',
				'step_args': {
	...
	window.onbeforeunload = function() {
		if ( cb_form_unsaved === true ) {
			return learndash_course_builder_assets.learndash_upload_message;
		}
	}

	// If we are submitting the form then don't show the warning. 
	var parent_form = jQuery( '#learndash_course_builder_box_wrap' ).parents( 'form' );
	...
	if ( touchEvent == 'hover' ) {
		jQuery( '#learndash_course_builder_box_wrap .learndash_builder_items' ).on( 'mouseover', '.ld-course-builder-actions', builder_step_show_element_actions );
		jQuery( '#learndash_course_builder_box_wrap .learndash_builder_items' ).on( 'mouseleave', '.ld-course-builder-actions', builder_step_hide_element_actions );

		jQuery( '#learndash_course_builder_box_wrap .learndash_selectors' ).on( 'mouseover', '.ld-course-builder-actions', builder_step_show_element_actions );
		jQuery( '#learndash_course_builder_box_wrap .learndash_selectors' ).on( 'mouseleave', '.ld-course-builder-actions', builder_step_hide_element_actions );


	} else if ( touchEvent == 'touchstart' ) {
		jQuery( '#learndash_course_builder_box_wrap .learndash_builder_items' ).on( 'click', '.ld-course-builder-actions', builder_step_show_element_actions );
		jQuery( '#learndash_course_builder_box_wrap .learndash_selectors' ).on( 'click', '.ld-course-builder-actions', builder_step_show_element_actions );
	}
		...
		if ( typeof sub_actions !== 'undefined' ) {
			...
			if ( typeof parent_id === 'undefined' ) {		
				if ( jQuery( sub_actions ).is(':visible' ) ) {
					...
					if ( touchEvent == 'touchstart' ) {
						jQuery( '#learndash_course_builder_box_wrap .ld-course-builder-sub-actions').hide();
					}
	...
	jQuery( '#learndash_course_builder_box_wrap' ).on( 'mouseover', '.ld-course-builder-title', builder_edit_title_show_pencil );
	jQuery( '#learndash_course_builder_box_wrap' ).on( 'mouseleave', '.ld-course-builder-title', builder_edit_title_hide_pencil );
	...
	jQuery( '#learndash_course_builder_box_wrap' ).on( 'click', '.ld-course-builder-title', builder_edit_title );
			...
			function handle_title_save(event_confirm) {
				...
				if ((title_new != '') && (title_new != title_org)) {
					...
					if (typeof parent_el !== 'undefined') {
						...
						var post_data = {
							'action': 'learndash_course_builder_selector_set_step_title',
							'new_title': title_new,
							'step_args': {
								'post_id': step_id,
								'post_type': step_type,
	...
	function selector_update_disabled_items( selector_type, disabled_ids ) {
		if ( selector_type !== '' ) {
			var selector_container = jQuery('#learndash_course_builder_box_wrap .learndash_selectors .learndash-selector-container[data-ld-type="'+selector_type+'"]' );
			if ( typeof selector_container !== 'undefined' ) {
	...
	function selector_set_item_disabled( selector_type, selected_id, disabled ) {
		if ( ( selector_type !== '' ) && ( selected_id !== '' ) )  {
			var disabled_items = jQuery('#learndash_course_builder_box_wrap .learndash_selectors .learndash-selector-container-'+selector_type).data('ld-selected');
			...
			var changed = false;
			if ( disabled === true ) {
				jQuery('#learndash_course_builder_box_wrap .learndash_selectors .learndash-selector-container-'+selector_type+' ul.learndash-selector-post-listing li[data-ld-id="'+selected_id+'"]' ).addClass( 'ld-disabled' );
				...
				jQuery('#learndash_course_builder_box_wrap .learndash_selectors .learndash-selector-container-'+selector_type+' ul.learndash-selector-post-listing li[data-ld-id="'+selected_id+'"]' ).removeClass( 'ld-disabled' );
				disabled_items = disabled_items.filter(function(e) { return e !== parseInt(selected_id) });
				changed = true;
			}
			if ( changed == true ) {
				jQuery('#learndash_course_builder_box_wrap .learndash_selectors .learndash-selector-container-'+selector_type).data('ld-selected', disabled_items );
			}
		}
	}
	...
	function selector_set_item_selected( selector_type, selected_id, selected ) {
		if ( ( selector_type !== '' ) || ( selected_id !== '' ) ) {
			...
			if ( selected === true ) {
				jQuery('#learndash_course_builder_box_wrap .learndash_selectors .learndash-selector-container-'+selector_type+' ul.learndash-selector-post-listing li[data-ld-id="'+selected_id+'"]').addClass( 'ld-selected' );
			} else {
				jQuery('#learndash_course_builder_box_wrap .learndash_selectors .learndash-selector-container-'+selector_type+' ul.learndash-selector-post-listing li[data-ld-id="'+selected_id+'"]').removeClass( 'ld-selected' );
			}
		}
	}
		...
		if ( !jQuery( event.currentTarget ).hasClass( 'ld-course-builder-action-add-pending' ) ) {
			...
			if ( typeof selector_container !== 'undefined' ) {
				...
				if ( typeof selector_type !== 'undefined' ) {
					...
					jQuery( '#learndash_course_builder_box_wrap .learndash_selectors ul#learndash-selector-post-listing-'+selector_type ).prepend( first_item );
					jQuery( '#learndash_course_builder_box_wrap .learndash_selectors ul#learndash-selector-post-listing-'+selector_type+' li' ).draggable( draggable_objects[selector_type] );
					jQuery( '#learndash_course_builder_box_wrap #'+new_item_id+' .ld-course-builder-title-text' ).trigger( 'click' );
	...
	function builder_trigger_new_steps_ajax( ) {
		...
		if ( ld_builder_new_step_ajax_pid == '' ) {
			...
			if ( jQuery( '#learndash_course_builder_box_wrap .ld-new-step' ).length ) {
				var new_items_set = {};

				//jQuery( '#learndash_course_builder_box_wrap .ld-new-step' ).slice(0, 2).each( function( item_idx, item_el ) {
				jQuery( '#learndash_course_builder_box_wrap .ld-new-step' ).each( function( item_idx, item_el ) {
				...
				if ( Object.keys(new_items_set).length > 0 ) {
					...
					var post_data = {
						'action': 'learndash_course_builder_selector_new_step',
							...
							if ( typeof reply_data !== 'undefined') {
								if ( typeof reply_data['new_steps'] !== 'undefined' ) {
									jQuery.each( reply_data['new_steps'], function ( old_step_id, new_step_set ) {
										if ( jQuery( '#learndash_course_builder_box_wrap #'+old_step_id ).length ) {
											if ( jQuery( '#learndash_course_builder_box_wrap #'+old_step_id ).hasClass( 'ld-new-step' ) ) {
												jQuery( '#learndash_course_builder_box_wrap #'+old_step_id ).removeClass( 'ld-new-step' );
												jQuery( '#learndash_course_builder_box_wrap #'+old_step_id ).attr('data-ld-id', new_step_set.post_id );
												jQuery( '#learndash_course_builder_box_wrap #'+old_step_id+' a.ld-course-builder-action-view' ).attr('href', new_step_set.view_url.replace(/&amp;/g, '&' ) );
												jQuery( '#learndash_course_builder_box_wrap #'+old_step_id+' a.ld-course-builder-action-edit' ).attr('href', new_step_set.edit_url.replace(/&amp;/g, '&' )  );
												jQuery( '#learndash_course_builder_box_wrap #'+old_step_id ).attr('id', 'ld-post-'+new_step_set.post_id );
											} 
										} 
									});
								}
	...
	jQuery('#learndash_course_builder_box_wrap .learndash_selectors').on('click', '.ld-show-all', builder_show_all_selectors );
	function builder_show_all_selectors( event ) {
		jQuery( '#learndash_course_builder_box_wrap .learndash_selectors h3.learndash-selector-header .ld-course-builder-action-show-hide').trigger('click', ['open'] );
	}

	jQuery('#learndash_course_builder_box_wrap .learndash_selectors').on('click', '.ld-hide-all', builder_hide_all_selectors );
	function builder_hide_all_selectors( event ) {
		jQuery( '#learndash_course_builder_box_wrap .learndash_selectors h3.learndash-selector-header .ld-course-builder-action-show-hide').trigger('click', ['close'] );
	}
	
	
	jQuery('#learndash_course_builder_box_wrap .learndash_builder_items').on('click', '.ld-show-all', builder_show_all_builders );
	function builder_show_all_builders( event ) {
		jQuery( '#learndash_course_builder_box_wrap .learndash_builder_items .ld-course-builder-action-show-hide').trigger('click', ['open'] );
	}

	jQuery('#learndash_course_builder_box_wrap .learndash_builder_items').on('click', '.ld-hide-all', builder_hide_all_builders );
	function builder_hide_all_builders( event ) {
		jQuery( '#learndash_course_builder_box_wrap .learndash_builder_items .ld-course-builder-action-show-hide').trigger('click', ['close'] );
	}
